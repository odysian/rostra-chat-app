...
- for Phase 3: Decision Locks are checked in the controlling issue (Task in `single`, Spec in `gated`)
...
For phased workflow upgrades (now vs later), see `docs/WORKFLOW_IMPROVEMENTS_WHITEBOARD.md`.
