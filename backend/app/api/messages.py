...
def get_room_messages(
    ...
    messages = message_crud.get_messages_by_room(db, room_id, limit)
    ...
    return [
        MessageResponse(
            ...
            room_id=msg.room_id,
            user_id=msg.user_id,
            username=msg.user.username,  # ← joinedload
            content=msg.content,
...
def create_message(
    ...
    # Create message
    db_message = message_crud.create_message(db, message, current_user.id)
